//  The FONT II - Exercise6Chapter15+.c
//  v1.0
/*  Includes ------------------------------------------------------------------*/
#include <mylib.h>
...
union Bitwise_font {
	...
	unsigned int my_font_int;
};

void show_font_par(unsigned int font_par_int);
char font_menu (void);
bool conversion(char option, unsigned int * font_par_int);
void set_font_id(unsigned int * font_par_int);
void set_font_size(unsigned int * font_par_int);
void set_alignment(unsigned int * font_par_int);
void set_bold(unsigned int * font_par_int);
void set_italic(unsigned int * font_par_int);
void set_underline(unsigned int * font_par_int);
...
bool conversion(char option, unsigned int * pt_font_par_int)
{
	bool end = false;
	switch(option)
	{
