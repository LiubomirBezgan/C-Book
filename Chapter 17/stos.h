...
// NA PRZYKLAD,
typedef int Pozycja;	// na potrzeby programu ???
...
// dzialanie:			oproznia stos
// warunki wstepne:		ws wskazuje na wczesniej zainicjowana stos
// warunki koncowe:		stos jest pusty
void WyczyscStos(Stos * ws);
#endif